...
#ifndef X_LIBRARIES_BASE_INCLUDE_TYPES_FLAT_ARRAY_H_
#define X_LIBRARIES_BASE_INCLUDE_TYPES_FLAT_ARRAY_H_
...
#undef LOG_TAG
#endif
#endif // X_LIBRARIES_BASE_INCLUDE_TYPES_FLAT_ARRAY_H_
