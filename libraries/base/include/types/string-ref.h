...
#ifndef X_LIBRARIES_BASE_INCLUDE_TYPES_STRING_REF_H_
#define X_LIBRARIES_BASE_INCLUDE_TYPES_STRING_REF_H_
...
#endif // X_LIBRARIES_BASE_INCLUDE_TYPES_STRING_REF_H_
