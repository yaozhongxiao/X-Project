 ...
 *
 */
#ifndef X_LIBRARIES_BASE_INCLUDE_THREADS_SPINLOCK_H_
#define X_LIBRARIES_BASE_INCLUDE_THREADS_SPINLOCK_H_
...
#endif // X_LIBRARIES_BASE_INCLUDE_THREADS_SPINLOCK_H_
