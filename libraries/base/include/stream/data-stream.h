 ...
 *
 */
#ifndef X_LIBRARIES_BASE_INCLUDE_STREAM_DATASTREAM_H_
#define X_LIBRARIES_BASE_INCLUDE_STREAM_DATASTREAM_H_
...
#endif // X_LIBRARIES_BASE_INCLUDE_STREAM_DATASTREAM_H_
